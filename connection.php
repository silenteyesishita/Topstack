...
//Insert Values
$sql = "INSERT INTO bookdb (bookname, bookdesc, bookauthor, booklang, bookfile,user_id,rating) 
VALUES ('$booknameVar', '$bookdescVar', '$bookauthorVar', '$booklangVar', '$bookfileVar','$user_id','$rating')";

//To check whether data is inserted properly or not
if ($conn->query($sql) === TRUE) {
	echo '<script type="text/javascript">'; 
	echo 'alert("New Book inserted successfully. Click OK to go to Book Display Section.");'; 
